    ...
    : IdentityDbContext<ApplicationUser, Role, string, IdentityUserClaim<string>, UserRole, IdentityUserLogin<string>, IdentityRoleClaim<string>, IdentityUserToken<string>>(options)
{
    ...
    public DbSet<Notifications> Notifications { get; set; } // Added Notifications DbSet
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureNotifications(modelBuilder); // Configure Notifications
    ...
    private static void ConfigureUser(ModelBuilder builder)
    {
        ...
        // Configure ApplicationUser relationship with Notifications
        builder.Entity<ApplicationUser>()
            .HasMany(u => u.Notifications) // One-to-Many with Notifications
            .WithOne(n => n.User) // Navigation property in Notifications
