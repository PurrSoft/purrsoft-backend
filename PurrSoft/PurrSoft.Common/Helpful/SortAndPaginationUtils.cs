namespace PurrSoft.Common.Helpful;
...
public static class SortAndPaginationUtils
{
        ...
        (this IQueryable<T> source, string sortBy, string sortDirection)
    {
        ...
        var parameter = System.Linq.Expressions
            .Expression.Parameter(type, "p");
        var propertyAccess = System.Linq.Expressions
            .Expression.MakeMemberAccess(parameter, property);
        var orderByExp = System.Linq.Expressions
            .Expression.Lambda(propertyAccess, parameter);

        var typeArguments = new Type[] { type, property.PropertyType };
        var methodName = string.Equals(sortDirection, "desc",
            StringComparison.OrdinalIgnoreCase) ? "OrderByDescending" : "OrderBy";
        var resultExp = System.Linq.Expressions
            .Expression
            .Call(typeof(Queryable), methodName, typeArguments, source.Expression, System.Linq.Expressions.Expression.Quote(orderByExp));
